...
class PayfortIntegration
{
     ...
     */
    public $merchantIdentifier = 'a6db2aea';//'CycHZxVj';
    
    /**
     * @var string your access code
     */
    public $accessCode         = 'NcwSQENI6CrY8i9Xxozf';
    
    /**
     * @var string SHA Request passphrase
     */
    public $SHARequestPhrase   = '$2y$10$w97UFgSBu';
    
    /**
     * @var string SHA Response passphrase
     */
    public $SHAResponsePhrase = '$2y$10$cPdHO0A7h';
     ...
     */
    public $projectUrlPath     = '/eshrahly/payfort-php-sdk'; 
    ...
    public function getRedirectionData($paymentMethod) {
        $merchantReference = 'XYZ9239-yu898';//$this->generateMerchantReference();
        if ($this->sandboxMode) {
