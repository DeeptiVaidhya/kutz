...
<aside class="right-side">
    ...
    <section class="content-header">
        <h1> Learning Level Information <small>Edit</small>
                    </h1>
    </section>
                    ...
                    <?php echo $this->session->flashdata('alert');?>
                        ...
                        <div class="box box-primary">
                            <div class="box-header">
                                <h3 class="box-title">Learning Level Information</h3>
                            </div>
                            <!-- /.box-header -->
                            <!-- form start -->
                            <form role="form" action="<?php echo base_url('index.php/Admin/editLearningLevelDetails');?>" method="post" >
                                <div class="box-body" style="padding: 20px;">
                                    <div class="form-group">
                                        <label for="exampleInputEmail1">Name <span class="intro" id="errorname"></span></label>
                                        <input type="hidden" class="form-control" name="id" value="<?php echo $learning_level->l_id;?>">
                                        <input type="text" class="form-control"  name="level_name" value="<?php echo $learning_level->level_name; ?>" placeholder="Enter Learning Level Name" required="">
                                    </div>
                                </div>
                                <!-- /.box-body -->
