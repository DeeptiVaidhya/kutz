                ...
                <?php echo $this->session->flashdata('success');?>
                    <?php echo $this->session->flashdata('alert');?>
                        ...
                        <div class="box box-primary">
                            ...
                            <!-- /.box-header -->
                            <!-- form start -->
                            <form role="form" action="<?php echo base_url('index.php/Admin/insertTeacher');?>" method="post" id="form" enctype="multipart/form-data" onsubmit="return validation();">
                                <div class="box-body" style="padding: 20px;">
                                    ...
                                    <div class="form-group">
                                     ...
                                     <div class="form-group">
                                        ...
                                        <select class="form-control" id = "teacher_gender" name="teacher_gender" style="text-transform: capitalize;">
                                     ...
                                     <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" id="teacher_password" name="teacher_password" placeholder="Enter Password" required="">
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select id="learning_levels" class="form-control chosen"  name="learning_levels" style="text-transform: capitalize;"  required="">
                                            <option>--Choose--</option>
                                            <?php 
                                     ...
                                     <div class="form-group">
                                        ...
                                        <select class="form-control chosen" id="learning_materials" name="learning_materials" style="text-transform: capitalize;" >
                                            <option>--Choose--</option>
                                            <?php 
