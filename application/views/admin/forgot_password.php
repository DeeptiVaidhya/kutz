    ...
    <body class="bg-black" >
        ...
        <div class="form-box" id="login-box">
            <center>
              ...
              <h4 style="color: #fff !important;">FORGOT PASSWORD</h4>
            </center>
            ...
            <form action="<?php echo base_url('index.php/Home/sendLinkToEmail');?>" method="post" name="login" id="login">
                <div class="body bg-transparent" style="background: none;margin-top: 10px;">
                    <div class="input-icons"> 
                        <i class="fa fa-envelope icon"></i> 
                        <input class="form-control" type="text" placeholder="Email" name="email" style="border-radius: 32px !important;background: #212121;border: 0px;color: white; padding: 14px 58px;" required="" > 
                    </div>
                </div>
